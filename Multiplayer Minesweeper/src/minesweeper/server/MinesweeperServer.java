...
public class MinesweeperServer {
     ...
     * 
     * SIZE_X and SIZE_Y are optional integer arguments specifying that a random
     * board of size SIZE_X*SIZE_Y should be generated. E.g.
     * "MinesweeperServer --size 42,69" starts the server initialized with a
     * random board of size 42*69.
     * 
     ...
     * @param sizeX
     *            If this argument is not null, start with a random board with
     *            width sizeX
     * @param sizeY
     *            If this argument is not null, start with a random board with
     *            height sizeY
